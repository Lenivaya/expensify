  ...
  render: () => (
    <EmptyPlaceholder>
      ...
      <EmptyPlaceholder.Description>
        You don&apos;t have any content yet. Start creating some!
      </EmptyPlaceholder.Description>
    </EmptyPlaceholder>
  )
}
...
export const WithButton: Story = {
  render: () => (
    <EmptyPlaceholder>
      ...
      <EmptyPlaceholder.Title>No expenses</EmptyPlaceholder.Title>
      <EmptyPlaceholder.Description>
        You haven&apos;t recorded any expenses yet. Create your first expense to
        start tracking.
      </EmptyPlaceholder.Description>
...
export const SearchResults: Story = {
  render: () => (
    <EmptyPlaceholder>
      ...
      <EmptyPlaceholder.Description>
        We couldn&apos;t find any expenses matching your search. Try adjusting
