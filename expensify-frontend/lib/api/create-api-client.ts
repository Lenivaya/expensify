...
): APIBasicQueryClientServices<Services, ServiceMethods>
export function createAPIClient(
  options: CreateAPIBasicClientOptions
): APIBasicClientServices<Services, ServiceMethods>
export function createAPIClient(): APIUtilityClientServices<
  Services,
  ServiceMethods
>
export function createAPIClient(
  ...
  | Services
  | APIBasicClientServices<Services, ServiceMethods>
  | APIUtilityClientServices<Services, ServiceMethods> {
  if (!options)
    return qraftAPIClient<Services, ServiceMethods>(services, callbacks)
  if ('requestFn' in options)
    return qraftAPIClient<Services, ServiceMethods>(
      services,
      callbacks,
      options
    )
