...
export interface InflowsService {
  ...
  inflowsControllerCreate: {
     ...
     */
    getMutationKey(
      parameters: InflowsControllerCreateParameters | void
    ): ServiceOperationMutationKey<
      InflowsControllerCreateSchema,
      InflowsControllerCreateParameters
    >
    /**
     ...
     */
    useMutation<
      TVariables extends InflowsControllerCreateBody,
      TContext = unknown
    >(
      parameters: InflowsControllerCreateParameters,
      options?: ServiceOperationUseMutationOptions<
        InflowsControllerCreateSchema,
        InflowsControllerCreateData,
        InflowsControllerCreateParameters,
        TVariables,
        InflowsControllerCreateError,
        TContext
      >
    ): UseMutationResult<
      InflowsControllerCreateData,
      InflowsControllerCreateError | Error,
  ...
  inflowsControllerFindAll: {
    ...
    cancelQueries<TInfinite extends boolean = false>(
      filters?:
        | QueryFiltersByParameters<
            ...
            TInfinite,
            InflowsControllerFindAllParameters,
     ...
     */
    getQueryKey(
      parameters: InflowsControllerFindAllParameters | void
    ): ServiceOperationQueryKey<
      InflowsControllerFindAllSchema,
      InflowsControllerFindAllParameters
    >
     ...
     * ```
     */
    useQuery<TData = InflowsControllerFindAllData>(
      parameters:
        | ServiceOperationQueryKey<
            InflowsControllerFindAllSchema,
            InflowsControllerFindAllParameters
          >
        | (InflowsControllerFindAllParameters | void),
      options?: Omit<
        UndefinedInitialDataOptions<
          InflowsControllerFindAllData,
          InflowsControllerFindAllError,
        ...
        'queryKey'
      >
    ): UseQueryResult<TData, InflowsControllerFindAllError | Error>
    /**
     * Performs asynchronous data fetching, manages loading states and error handling.
     *
     * @summary Get all inflows
    ...
    useQuery<TData = InflowsControllerFindAllData>(
      ...
      options: Omit<
        ...
        'queryKey'
      >
    ): DefinedUseQueryResult<TData, InflowsControllerFindAllError | Error>
    /**
     * @summary Get all inflows
     * @description Retrieve all inflows for the authenticated user with pagination and filtering options
     */
    fetchInfiniteQuery<TPageParam extends InflowsControllerFindAllParameters>(
    ...
    prefetchInfiniteQuery<
      TPageParam extends InflowsControllerFindAllParameters
    >(
      options: ServiceOperationFetchInfiniteQueryOptions<
        InflowsControllerFindAllSchema,
        InflowsControllerFindAllData,
    ...
    fetchQuery(
      options: ServiceOperationFetchQueryOptions<
        ...
        InflowsControllerFindAllError
      > | void
    ): Promise<InflowsControllerFindAllData>
    /**
     * @summary Get all inflows
     * @description Retrieve all inflows for the authenticated user with pagination and filtering options
     */
    ...
    getQueryData(
      parameters:
        | ServiceOperationQueryKey<
          ...
          >
        | (InflowsControllerFindAllParameters | void)
    ): InflowsControllerFindAllData | undefined
    /**
     * @summary Get all inflows
     * @description Retrieve all inflows for the authenticated user with pagination and filtering options
     */
    getQueryState(
      ...
      | QueryState<InflowsControllerFindAllData, InflowsControllerFindAllError>
      | undefined
    /**
     * @summary Get all inflows
     * @description Retrieve all inflows for the authenticated user with pagination and filtering options
    ...
    setQueriesData<TInfinite extends boolean = false>(
      filters:
        ...
        | QueryFiltersByQueryKey<
          ...
          >,
      updater: Updater<
        NoInfer<InflowsControllerFindAllData> | undefined,
        NoInfer<InflowsControllerFindAllData> | undefined
      >,
      options?: SetDataOptions
    ): Array<InflowsControllerFindAllData | undefined>
    /**
     * @summary Get all inflows
     * @description Retrieve all inflows for the authenticated user with pagination and filtering options
     */
    setQueryData(
      parameters:
        | (InflowsControllerFindAllParameters | undefined)
        | ServiceOperationQueryKey<
            InflowsControllerFindAllSchema,
            InflowsControllerFindAllParameters
          >,
    ...
    useInfiniteQuery<
      TPageParam extends InflowsControllerFindAllParameters,
      TData = InflowsControllerFindAllData
    >(
      parameters:
        | ServiceOperationInfiniteQueryKey<
            InflowsControllerFindAllSchema,
      ...
      options: Omit<
        UndefinedInitialDataInfiniteOptions<
          InflowsControllerFindAllData,
          InflowsControllerFindAllError,
          OperationInfiniteData<TData, InflowsControllerFindAllParameters>,
          ServiceOperationInfiniteQueryKey<
            InflowsControllerFindAllSchema,
            InflowsControllerFindAllParameters
          >,
      ...
      OperationInfiniteData<TData, InflowsControllerFindAllParameters>,
      InflowsControllerFindAllError | Error
    >
    /**
     * Performs asynchronous data fetching with support for infinite scrolling scenarios.
     * Manages paginated data and provides utilities for fetching additional pages.
     ...
     * @description Retrieve all inflows for the authenticated user with pagination and filtering options
     */
    useSuspenseQuery<TData = InflowsControllerFindAllData>(
      parameters:
        | ServiceOperationQueryKey<
            InflowsControllerFindAllSchema,
            InflowsControllerFindAllParameters
      ...
      options?: Omit<
        ...
        'queryKey'
      >
    ): UseSuspenseQueryResult<TData, InflowsControllerFindAllError | Error>
    schema: InflowsControllerFindAllSchema
    types: {
      parameters: InflowsControllerFindAllParameters
  ...
  inflowsControllerFindOne: {
    ...
    cancelQueries<TInfinite extends boolean = false>(
      filters?:
        | QueryFiltersByParameters<
            InflowsControllerFindOneSchema,
            InflowsControllerFindOneData,
            TInfinite,
            InflowsControllerFindOneParameters,
            InflowsControllerFindOneError
          >
        | QueryFiltersByQueryKey<
            InflowsControllerFindOneSchema,
            InflowsControllerFindOneData,
     ...
     * ```
     */
    useQuery<TData = InflowsControllerFindOneData>(
      parameters:
        | ServiceOperationQueryKey<
            InflowsControllerFindOneSchema,
            InflowsControllerFindOneParameters
      ...
      options?: Omit<
        ...
        'queryKey'
      >
    ): UseQueryResult<TData, InflowsControllerFindOneError | Error>
    /**
     * Performs asynchronous data fetching, manages loading states and error handling.
     *
     * @summary Get inflow by ID
    ...
    useQuery<TData = InflowsControllerFindOneData>(
      ...
      options: Omit<
        ...
        'queryKey'
      >
    ): DefinedUseQueryResult<TData, InflowsControllerFindOneError | Error>
    /**
     * @summary Get inflow by ID
     * @description Retrieve a specific inflow by its ID
     */
    fetchInfiniteQuery<TPageParam extends InflowsControllerFindOneParameters>(
      options: ServiceOperationFetchInfiniteQueryOptions<
        InflowsControllerFindOneSchema,
        InflowsControllerFindOneData,
        InflowsControllerFindOneParameters,
     ...
     */
    prefetchInfiniteQuery<
      TPageParam extends InflowsControllerFindOneParameters
    >(
      options: ServiceOperationFetchInfiniteQueryOptions<
        InflowsControllerFindOneSchema,
        InflowsControllerFindOneData,
    ...
    fetchQuery(
      options: ServiceOperationFetchQueryOptions<
        ...
        InflowsControllerFindOneError
      >
    ): Promise<InflowsControllerFindOneData>
    /**
     * @summary Get inflow by ID
     * @description Retrieve a specific inflow by its ID
     */
    ...
    getQueryData(
      parameters:
        | ServiceOperationQueryKey<
          ...
          >
        | InflowsControllerFindOneParameters
    ): InflowsControllerFindOneData | undefined
    /**
     * @summary Get inflow by ID
     * @description Retrieve a specific inflow by its ID
     */
    getQueryState(
      ...
      | QueryState<InflowsControllerFindOneData, InflowsControllerFindOneError>
      | undefined
    /**
     * @summary Get inflow by ID
     * @description Retrieve a specific inflow by its ID
    ...
    setQueriesData<TInfinite extends boolean = false>(
      filters:
        ...
        | QueryFiltersByQueryKey<
          ...
          >,
      updater: Updater<
        NoInfer<InflowsControllerFindOneData> | undefined,
        NoInfer<InflowsControllerFindOneData> | undefined
      >,
      options?: SetDataOptions
    ): Array<InflowsControllerFindOneData | undefined>
    /**
     * @summary Get inflow by ID
     * @description Retrieve a specific inflow by its ID
     */
    ...
    useInfiniteQuery<
      TPageParam extends InflowsControllerFindOneParameters,
      TData = InflowsControllerFindOneData
    >(
      parameters:
        | ServiceOperationInfiniteQueryKey<
            InflowsControllerFindOneSchema,
      ...
      options: Omit<
        UndefinedInitialDataInfiniteOptions<
          InflowsControllerFindOneData,
          InflowsControllerFindOneError,
          OperationInfiniteData<TData, InflowsControllerFindOneParameters>,
          ServiceOperationInfiniteQueryKey<
            InflowsControllerFindOneSchema,
            InflowsControllerFindOneParameters
          >,
     ...
     * @description Retrieve a specific inflow by its ID
     */
    useSuspenseQuery<TData = InflowsControllerFindOneData>(
      parameters:
        | ServiceOperationQueryKey<
            InflowsControllerFindOneSchema,
            InflowsControllerFindOneParameters
      ...
      options?: Omit<
        ...
        'queryKey'
      >
    ): UseSuspenseQueryResult<TData, InflowsControllerFindOneError | Error>
    schema: InflowsControllerFindOneSchema
    types: {
      parameters: InflowsControllerFindOneParameters
  ...
  inflowsControllerUpdate: {
     ...
     */
    getMutationKey(
      parameters: InflowsControllerUpdateParameters | void
    ): ServiceOperationMutationKey<
      InflowsControllerUpdateSchema,
     ...
     */
    useMutation<
      TVariables extends InflowsControllerUpdateBody,
      TContext = unknown
    >(
      parameters: InflowsControllerUpdateParameters,
      options?: ServiceOperationUseMutationOptions<
        InflowsControllerUpdateSchema,
        InflowsControllerUpdateData,
        InflowsControllerUpdateParameters,
        TVariables,
      ...
      InflowsControllerUpdateData,
      InflowsControllerUpdateError | Error,
      AreAllOptional<TVariables> extends true ? TVariables | void : TVariables,
      TContext
    >
    /**
  ...
  inflowsControllerRemove: {
     ...
     */
    getMutationKey(
      parameters: InflowsControllerRemoveParameters | void
    ): ServiceOperationMutationKey<
      InflowsControllerRemoveSchema,
      InflowsControllerRemoveParameters
    >
    /**
     * Enables performing asynchronous data mutation operations such as POST, PUT, PATCH, or DELETE requests.
     * Handles loading state, optimistic updates, and error handling.
     ...
     */
    useMutation<
      TVariables extends InflowsControllerRemoveBody,
      TContext = unknown
    >(
      parameters: InflowsControllerRemoveParameters,
      options?: ServiceOperationUseMutationOptions<
        InflowsControllerRemoveSchema,
        InflowsControllerRemoveData,
        InflowsControllerRemoveParameters,
        TVariables,
        InflowsControllerRemoveError,
        TContext
      >
    ): UseMutationResult<
      InflowsControllerRemoveData,
      InflowsControllerRemoveError | Error,
      AreAllOptional<TVariables> extends true ? TVariables | void : TVariables,
      TContext
    >
    /**
  ...
  inflowsControllerGetTotalInflow: {
    ...
    cancelQueries<TInfinite extends boolean = false>(
      filters?:
        | QueryFiltersByParameters<
            InflowsControllerGetTotalInflowSchema,
            InflowsControllerGetTotalInflowData,
            TInfinite,
            InflowsControllerGetTotalInflowParameters,
     ...
     */
    getQueryKey(
      parameters: InflowsControllerGetTotalInflowParameters | void
    ): ServiceOperationQueryKey<
      InflowsControllerGetTotalInflowSchema,
      InflowsControllerGetTotalInflowParameters
    >
    ...
    useQuery<TData = InflowsControllerGetTotalInflowData>(
      parameters:
        | ServiceOperationQueryKey<
            ...
            InflowsControllerGetTotalInflowParameters
          >
        | (InflowsControllerGetTotalInflowParameters | void),
      options?: Omit<
        UndefinedInitialDataOptions<
          InflowsControllerGetTotalInflowData,
          InflowsControllerGetTotalInflowError,
        ...
        'queryKey'
      >
    ): UseQueryResult<TData, InflowsControllerGetTotalInflowError | Error>
    /**
     * Performs asynchronous data fetching, manages loading states and error handling.
     *
     * @summary Get total inflow
     ...
     */
    fetchInfiniteQuery<
      TPageParam extends InflowsControllerGetTotalInflowParameters
    >(
      options: ServiceOperationFetchInfiniteQueryOptions<
        InflowsControllerGetTotalInflowSchema,
        InflowsControllerGetTotalInflowData,
    ...
    fetchQuery(
      options: ServiceOperationFetchQueryOptions<
        ...
        InflowsControllerGetTotalInflowError
      > | void
    ): Promise<InflowsControllerGetTotalInflowData>
    /**
     * @summary Get total inflow
     * @description Get the total amount received across all inflows
     */
    ...
    getQueryData(
      parameters:
        | ServiceOperationQueryKey<
          ...
          >
        | (InflowsControllerGetTotalInflowParameters | void)
    ): InflowsControllerGetTotalInflowData | undefined
    /**
     * @summary Get total inflow
     * @description Get the total amount received across all inflows
     */
    ...
    setQueriesData<TInfinite extends boolean = false>(
      filters:
        ...
        | QueryFiltersByQueryKey<
          ...
          >,
      updater: Updater<
        NoInfer<InflowsControllerGetTotalInflowData> | undefined,
        NoInfer<InflowsControllerGetTotalInflowData> | undefined
      >,
      options?: SetDataOptions
    ): Array<InflowsControllerGetTotalInflowData | undefined>
    /**
     * @summary Get total inflow
     * @description Get the total amount received across all inflows
     */
    setQueryData(
      parameters:
        | (InflowsControllerGetTotalInflowParameters | undefined)
        | ServiceOperationQueryKey<
            InflowsControllerGetTotalInflowSchema,
            InflowsControllerGetTotalInflowParameters
          >,
  ...
  inflowsControllerGetTagStats: {
     ...
     */
    getQueryKey(
      parameters: InflowsControllerGetTagStatsParameters | void
    ): ServiceOperationQueryKey<
      InflowsControllerGetTagStatsSchema,
      InflowsControllerGetTagStatsParameters
    >
    ...
    useQuery<TData = InflowsControllerGetTagStatsData>(
      parameters:
        | ServiceOperationQueryKey<
            ...
            InflowsControllerGetTagStatsParameters
          >
        | (InflowsControllerGetTagStatsParameters | void),
      options?: Omit<
        UndefinedInitialDataOptions<
          InflowsControllerGetTagStatsData,
          InflowsControllerGetTagStatsError,
        ...
        'queryKey'
      >
    ): UseQueryResult<TData, InflowsControllerGetTagStatsError | Error>
    /**
     * Performs asynchronous data fetching, manages loading states and error handling.
     *
     * @summary Get tag statistics
    ...
    useQuery<TData = InflowsControllerGetTagStatsData>(
      ...
      options: Omit<
        ...
        'queryKey'
      >
    ): DefinedUseQueryResult<TData, InflowsControllerGetTagStatsError | Error>
    /**
     * @summary Get tag statistics
     * @description Get statistics about inflow tags including count and total amount
     */
    fetchInfiniteQuery<
      TPageParam extends InflowsControllerGetTagStatsParameters
    >(
      options: ServiceOperationFetchInfiniteQueryOptions<
        InflowsControllerGetTagStatsSchema,
        InflowsControllerGetTagStatsData,
    ...
    fetchQuery(
      options: ServiceOperationFetchQueryOptions<
        ...
        InflowsControllerGetTagStatsError
      > | void
    ): Promise<InflowsControllerGetTagStatsData>
    /**
     * @summary Get tag statistics
     * @description Get statistics about inflow tags including count and total amount
     */
    ...
    getQueryData(
      parameters:
        | ServiceOperationQueryKey<
          ...
          >
        | (InflowsControllerGetTagStatsParameters | void)
    ): InflowsControllerGetTagStatsData | undefined
    /**
     * @summary Get tag statistics
     * @description Get statistics about inflow tags including count and total amount
     */
    ...
    setQueriesData<TInfinite extends boolean = false>(
      filters:
        ...
        | QueryFiltersByQueryKey<
          ...
          >,
      updater: Updater<
        NoInfer<InflowsControllerGetTagStatsData> | undefined,
        NoInfer<InflowsControllerGetTagStatsData> | undefined
      >,
      options?: SetDataOptions
    ): Array<InflowsControllerGetTagStatsData | undefined>
    /**
     * @summary Get tag statistics
     * @description Get statistics about inflow tags including count and total amount
     */
    setQueryData(
      parameters:
        | (InflowsControllerGetTagStatsParameters | undefined)
        | ServiceOperationQueryKey<
            InflowsControllerGetTagStatsSchema,
            InflowsControllerGetTagStatsParameters
          >,
    ...
    useInfiniteQuery<
      TPageParam extends InflowsControllerGetTagStatsParameters,
      TData = InflowsControllerGetTagStatsData
    >(
      parameters:
        | ServiceOperationInfiniteQueryKey<
            InflowsControllerGetTagStatsSchema,
      ...
      options: Omit<
        UndefinedInitialDataInfiniteOptions<
          InflowsControllerGetTagStatsData,
          InflowsControllerGetTagStatsError,
          OperationInfiniteData<TData, InflowsControllerGetTagStatsParameters>,
          ServiceOperationInfiniteQueryKey<
            InflowsControllerGetTagStatsSchema,
            InflowsControllerGetTagStatsParameters
          >,
    ...
    useSuspenseQuery<TData = InflowsControllerGetTagStatsData>(
      ...
      options?: Omit<
        ...
        'queryKey'
      >
    ): UseSuspenseQueryResult<TData, InflowsControllerGetTagStatsError | Error>
    schema: InflowsControllerGetTagStatsSchema
    types: {
      parameters: InflowsControllerGetTagStatsParameters
  ...
  inflowsControllerGetMonthlyStats: {
    ...
    cancelQueries<TInfinite extends boolean = false>(
      filters?:
        | QueryFiltersByParameters<
            InflowsControllerGetMonthlyStatsSchema,
    ...
    useQuery<TData = InflowsControllerGetMonthlyStatsData>(
      ...
      options?: Omit<
        ...
        'queryKey'
      >
    ): UseQueryResult<TData, InflowsControllerGetMonthlyStatsError | Error>
    /**
     * Performs asynchronous data fetching, manages loading states and error handling.
     *
     * @summary Get monthly statistics
     ...
     */
    fetchInfiniteQuery<
      TPageParam extends InflowsControllerGetMonthlyStatsParameters
    >(
      options: ServiceOperationFetchInfiniteQueryOptions<
        InflowsControllerGetMonthlyStatsSchema,
        InflowsControllerGetMonthlyStatsData,
    ...
    fetchQuery(
      options: ServiceOperationFetchQueryOptions<
        ...
        InflowsControllerGetMonthlyStatsError
      >
    ): Promise<InflowsControllerGetMonthlyStatsData>
    /**
     * @summary Get monthly statistics
     * @description Get monthly inflow statistics for a specific year
     */
    ...
    getQueryData(
      parameters:
        | ServiceOperationQueryKey<
          ...
          >
        | InflowsControllerGetMonthlyStatsParameters
    ): InflowsControllerGetMonthlyStatsData | undefined
    /**
     * @summary Get monthly statistics
     * @description Get monthly inflow statistics for a specific year
     */
    ...
    setQueriesData<TInfinite extends boolean = false>(
      filters:
        ...
        | QueryFiltersByQueryKey<
          ...
          >,
      updater: Updater<
        NoInfer<InflowsControllerGetMonthlyStatsData> | undefined,
        NoInfer<InflowsControllerGetMonthlyStatsData> | undefined
      >,
      options?: SetDataOptions
    ): Array<InflowsControllerGetMonthlyStatsData | undefined>
    /**
     * @summary Get monthly statistics
     * @description Get monthly inflow statistics for a specific year
     */
    ...
    >(
      ...
      OperationInfiniteData<TData, InflowsControllerGetMonthlyStatsParameters>,
      InflowsControllerGetMonthlyStatsError | Error
    >
    /**
     * Performs asynchronous data fetching with support for infinite scrolling scenarios.
...
type InflowsControllerCreateData =
  paths['/inflows']['post']['responses']['201']['content']['application/json']
type InflowsControllerCreateError = unknown
type InflowsControllerCreateBody = NonNullable<
  paths['/inflows']['post']['requestBody']
...
type InflowsControllerFindAllData =
  paths['/inflows']['get']['responses']['200']['content']['application/json']
...
type InflowsControllerFindOneParameters =
  paths['/inflows/{id}']['get']['parameters']
type InflowsControllerFindOneData =
  paths['/inflows/{id}']['get']['responses']['200']['content']['application/json']
...
type InflowsControllerUpdateParameters =
  paths['/inflows/{id}']['patch']['parameters']
type InflowsControllerUpdateData =
  paths['/inflows/{id}']['patch']['responses']['200']['content']['application/json']
type InflowsControllerUpdateError = unknown
type InflowsControllerUpdateBody = NonNullable<
  paths['/inflows/{id}']['patch']['requestBody']
>['content']['application/json']
...
type InflowsControllerRemoveParameters =
  paths['/inflows/{id}']['delete']['parameters']
type InflowsControllerRemoveData =
  paths['/inflows/{id}']['delete']['responses']['200']['content']['application/json']
...
type InflowsControllerGetTotalInflowData =
  paths['/inflows/stats/total']['get']['responses']['200']['content']['application/json']
...
type InflowsControllerGetTagStatsData =
  paths['/inflows/stats/tags']['get']['responses']['200']['content']['application/json']
...
type InflowsControllerGetMonthlyStatsParameters =
  paths['/inflows/stats/monthly/{year}']['get']['parameters']
type InflowsControllerGetMonthlyStatsData =
  paths['/inflows/stats/monthly/{year}']['get']['responses']['200']['content']['application/json']
