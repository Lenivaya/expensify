...
type UsersControllerGetBalanceHistoryParameters =
  paths['/users/{id}/balance-history']['get']['parameters']
type UsersControllerGetBalanceHistoryData =
  paths['/users/{id}/balance-history']['get']['responses']['200']['content']['application/json']
