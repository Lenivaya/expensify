...
export interface UsersService {
    ...
    usersControllerGetBalanceHistory: {
         ...
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        getQueryKey(parameters: UsersControllerGetBalanceHistoryParameters): ServiceOperationQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters>;
        /**
         * Performs asynchronous data fetching, manages loading states and error handling.
         *
         * @summary Get balance history
         ...
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        fetchQuery(options: ServiceOperationFetchQueryOptions<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryParameters, UsersControllerGetBalanceHistoryError>): Promise<UsersControllerGetBalanceHistoryData>;
        /**
         * @summary Get balance history
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        prefetchQuery(options: ServiceOperationFetchQueryOptions<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryParameters, UsersControllerGetBalanceHistoryError>): Promise<void>;
        /**
         * @summary Get balance history
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        ensureQueryData(options: ServiceOperationEnsureQueryDataOptions<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryParameters, UsersControllerGetBalanceHistoryError>): Promise<UsersControllerGetBalanceHistoryData>;
        /**
         * @summary Get balance history
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        getInfiniteQueryData(parameters: ServiceOperationInfiniteQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters> | (UsersControllerGetBalanceHistoryParameters)): OperationInfiniteData<UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryParameters> | undefined;
        /**
         * @summary Get balance history
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
         ...
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        getQueryData(parameters: ServiceOperationQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters> | (UsersControllerGetBalanceHistoryParameters)): UsersControllerGetBalanceHistoryData | undefined;
        /**
         * @summary Get balance history
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        getQueryState(parameters: ServiceOperationQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters> | (UsersControllerGetBalanceHistoryParameters)): QueryState<UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryError> | undefined;
        /**
         * @summary Get balance history
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        getInfiniteQueryState(parameters: UsersControllerGetBalanceHistoryParameters | ServiceOperationInfiniteQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters>): QueryState<OperationInfiniteData<UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryParameters>, UsersControllerGetBalanceHistoryError> | undefined;
        /**
         * @summary Get balance history
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
         ...
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        <TMeta extends Record<string, any>, TSignal extends AbortSignal = AbortSignal>(options: QueryFnOptionsByQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters, TMeta, TSignal> | (QueryFnOptionsByParameters<UsersControllerGetBalanceHistoryParameters, TMeta, TSignal>), client?: (schema: UsersControllerGetBalanceHistorySchema, options: {
         ...
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        setQueryData(parameters: (UsersControllerGetBalanceHistoryParameters) | ServiceOperationQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters>, updater: Updater<NoInfer<UsersControllerGetBalanceHistoryData> | undefined, NoInfer<UsersControllerGetBalanceHistoryData> | undefined>, options?: SetDataOptions): UsersControllerGetBalanceHistoryData | undefined;
        /**
         * @summary Get balance history
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        getInfiniteQueryKey(parameters: UsersControllerGetBalanceHistoryParameters): ServiceOperationInfiniteQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters>;
        /**
         * Performs asynchronous data fetching with support for infinite scrolling scenarios.
         * Manages paginated data and provides utilities for fetching additional pages.
         *
         ...
         * @example Checks the number of normal queries fetching with the specified parameters.
         * ```ts
         * const usersControllerGetBalanceHistoryByParametersTotal = qraft.usersService.usersControllerGetBalanceHistory.useIsFetching({
         *     infinite: false,
         *     parameters: {
         *         path: {
         *             id: id
...
type UsersControllerGetBalanceHistoryParameters = paths["/users/{id}/balance-history"]["get"]["parameters"];
type UsersControllerGetBalanceHistoryData = paths["/users/{id}/balance-history"]["get"]["responses"]["200"]["content"]["application/json"];
