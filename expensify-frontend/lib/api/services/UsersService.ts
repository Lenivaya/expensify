...
export interface UsersService {
    ...
    usersControllerUpdateUser: {
         ...
         * ```
         */
        useMutation<TVariables extends UsersControllerUpdateUserBody, TContext = unknown>(parameters: UsersControllerUpdateUserParameters, options?: ServiceOperationUseMutationOptions<UsersControllerUpdateUserSchema, UsersControllerUpdateUserData, UsersControllerUpdateUserParameters, TVariables, UsersControllerUpdateUserError | Error, TContext>): UseMutationResult<UsersControllerUpdateUserData, UsersControllerUpdateUserError | Error, AreAllOptional<TVariables> extends true ? TVariables | void : TVariables, TContext>;
        /**
         * Enables performing asynchronous data mutation operations such as POST, PUT, PATCH, or DELETE requests.
         * Handles loading state, optimistic updates, and error handling.
         *
         ...
         * ```
         */
        useMutation<TVariables extends MutationVariables<UsersControllerUpdateUserBody, UsersControllerUpdateUserParameters>, TContext = unknown>(parameters: void, options?: ServiceOperationUseMutationOptions<UsersControllerUpdateUserSchema, UsersControllerUpdateUserData, UsersControllerUpdateUserParameters, TVariables, UsersControllerUpdateUserError | Error, TContext>): UseMutationResult<UsersControllerUpdateUserData, UsersControllerUpdateUserError | Error, TVariables, TContext>;
        /**
         ...
         * ```
         */
        useIsMutating<TContext = unknown>(filters?: MutationFiltersByParameters<UsersControllerUpdateUserBody, UsersControllerUpdateUserData, UsersControllerUpdateUserParameters, UsersControllerUpdateUserError | Error, TContext> | MutationFiltersByMutationKey<UsersControllerUpdateUserSchema, UsersControllerUpdateUserBody, UsersControllerUpdateUserData, UsersControllerUpdateUserParameters, UsersControllerUpdateUserError | Error, TContext>): number;
        /**
         * @summary Updates user
         * @description This endpoint allows the user to update their details. Note that this requires authentication of user you are updating.
         */
         ...
         * ```
         */
        useMutationState<TContext = unknown, TResult = MutationState<UsersControllerUpdateUserData, UsersControllerUpdateUserError | Error, MutationVariables<UsersControllerUpdateUserBody, UsersControllerUpdateUserParameters>, TContext>>(options?: {
            filters?: MutationFiltersByParameters<UsersControllerUpdateUserBody, UsersControllerUpdateUserData, UsersControllerUpdateUserParameters, UsersControllerUpdateUserError | Error, TContext> | MutationFiltersByMutationKey<UsersControllerUpdateUserSchema, UsersControllerUpdateUserBody, UsersControllerUpdateUserData, UsersControllerUpdateUserParameters, UsersControllerUpdateUserError | Error, TContext>;
            select?: (mutation: Mutation<UsersControllerUpdateUserData, UsersControllerUpdateUserError | Error, MutationVariables<UsersControllerUpdateUserBody, UsersControllerUpdateUserParameters>, TContext>) => TResult;
        }): Array<TResult>;
        schema: UsersControllerUpdateUserSchema;
        types: {
    ...
    usersControllerDeleteUser: {
         ...
         * ```
         */
        useMutation<TVariables extends UsersControllerDeleteUserBody, TContext = unknown>(parameters: UsersControllerDeleteUserParameters, options?: ServiceOperationUseMutationOptions<UsersControllerDeleteUserSchema, UsersControllerDeleteUserData, UsersControllerDeleteUserParameters, TVariables, UsersControllerDeleteUserError | Error, TContext>): UseMutationResult<UsersControllerDeleteUserData, UsersControllerDeleteUserError | Error, AreAllOptional<TVariables> extends true ? TVariables | void : TVariables, TContext>;
        /**
         * Enables performing asynchronous data mutation operations such as POST, PUT, PATCH, or DELETE requests.
         * Handles loading state, optimistic updates, and error handling.
         *
         ...
         * ```
         */
        useMutation<TVariables extends MutationVariables<UsersControllerDeleteUserBody, UsersControllerDeleteUserParameters>, TContext = unknown>(parameters: void, options?: ServiceOperationUseMutationOptions<UsersControllerDeleteUserSchema, UsersControllerDeleteUserData, UsersControllerDeleteUserParameters, TVariables, UsersControllerDeleteUserError | Error, TContext>): UseMutationResult<UsersControllerDeleteUserData, UsersControllerDeleteUserError | Error, TVariables, TContext>;
        /**
         * Returns the count of currently in-progress mutations.
         *
         * @summary Delete user account and all associated data
         ...
         * ```
         */
        useMutationState<TContext = unknown, TResult = MutationState<UsersControllerDeleteUserData, UsersControllerDeleteUserError | Error, MutationVariables<UsersControllerDeleteUserBody, UsersControllerDeleteUserParameters>, TContext>>(options?: {
            filters?: MutationFiltersByParameters<UsersControllerDeleteUserBody, UsersControllerDeleteUserData, UsersControllerDeleteUserParameters, UsersControllerDeleteUserError | Error, TContext> | MutationFiltersByMutationKey<UsersControllerDeleteUserSchema, UsersControllerDeleteUserBody, UsersControllerDeleteUserData, UsersControllerDeleteUserParameters, UsersControllerDeleteUserError | Error, TContext>;
            select?: (mutation: Mutation<UsersControllerDeleteUserData, UsersControllerDeleteUserError | Error, MutationVariables<UsersControllerDeleteUserBody, UsersControllerDeleteUserParameters>, TContext>) => TResult;
        }): Array<TResult>;
    ...
    usersControllerGetFinancialSummary: {
         ...
         * @description Get comprehensive financial summary including balance and statistics
         */
        getQueryKey(parameters: UsersControllerGetFinancialSummaryParameters | void): ServiceOperationQueryKey<UsersControllerGetFinancialSummarySchema, UsersControllerGetFinancialSummaryParameters>;
        /**
         * Performs asynchronous data fetching, manages loading states and error handling.
         *
         * @summary Get financial summary
         ...
         * @description Get comprehensive financial summary including balance and statistics
         */
        fetchQuery(options: ServiceOperationFetchQueryOptions<UsersControllerGetFinancialSummarySchema, UsersControllerGetFinancialSummaryData, UsersControllerGetFinancialSummaryParameters, UsersControllerGetFinancialSummaryError> | void): Promise<UsersControllerGetFinancialSummaryData>;
        /**
         * @summary Get financial summary
         * @description Get comprehensive financial summary including balance and statistics
         */
        prefetchQuery(options: ServiceOperationFetchQueryOptions<UsersControllerGetFinancialSummarySchema, UsersControllerGetFinancialSummaryData, UsersControllerGetFinancialSummaryParameters, UsersControllerGetFinancialSummaryError> | void): Promise<void>;
        /**
         * @summary Get financial summary
         * @description Get comprehensive financial summary including balance and statistics
         */
        ensureQueryData(options: ServiceOperationEnsureQueryDataOptions<UsersControllerGetFinancialSummarySchema, UsersControllerGetFinancialSummaryData, UsersControllerGetFinancialSummaryParameters, UsersControllerGetFinancialSummaryError> | void): Promise<UsersControllerGetFinancialSummaryData>;
        /**
         * @summary Get financial summary
         * @description Get comprehensive financial summary including balance and statistics
         */
         ...
         * @description Get comprehensive financial summary including balance and statistics
         */
        getQueryData(parameters: ServiceOperationQueryKey<UsersControllerGetFinancialSummarySchema, UsersControllerGetFinancialSummaryParameters> | (UsersControllerGetFinancialSummaryParameters | void)): UsersControllerGetFinancialSummaryData | undefined;
        /**
         * @summary Get financial summary
         * @description Get comprehensive financial summary including balance and statistics
         */
        getQueryState(parameters: ServiceOperationQueryKey<UsersControllerGetFinancialSummarySchema, UsersControllerGetFinancialSummaryParameters> | (UsersControllerGetFinancialSummaryParameters | void)): QueryState<UsersControllerGetFinancialSummaryData, UsersControllerGetFinancialSummaryError> | undefined;
        /**
         * @summary Get financial summary
         * @description Get comprehensive financial summary including balance and statistics
         */
        getInfiniteQueryState(parameters: UsersControllerGetFinancialSummaryParameters | ServiceOperationInfiniteQueryKey<UsersControllerGetFinancialSummarySchema, UsersControllerGetFinancialSummaryParameters> | void): QueryState<OperationInfiniteData<UsersControllerGetFinancialSummaryData, UsersControllerGetFinancialSummaryParameters>, UsersControllerGetFinancialSummaryError> | undefined;
        /**
         * @summary Get financial summary
         * @description Get comprehensive financial summary including balance and statistics
         */
         ...
         * @description Get comprehensive financial summary including balance and statistics
         */
        <TMeta extends Record<string, any>, TSignal extends AbortSignal = AbortSignal>(options: QueryFnOptionsByQueryKey<UsersControllerGetFinancialSummarySchema, UsersControllerGetFinancialSummaryParameters, TMeta, TSignal> | (QueryFnOptionsByParameters<UsersControllerGetFinancialSummaryParameters, TMeta, TSignal> | void), client?: (schema: UsersControllerGetFinancialSummarySchema, options: {
         ...
         * @description Get comprehensive financial summary including balance and statistics
         */
        setQueryData(parameters: (UsersControllerGetFinancialSummaryParameters | undefined) | ServiceOperationQueryKey<UsersControllerGetFinancialSummarySchema, UsersControllerGetFinancialSummaryParameters>, updater: Updater<NoInfer<UsersControllerGetFinancialSummaryData> | undefined, NoInfer<UsersControllerGetFinancialSummaryData> | undefined>, options?: SetDataOptions): UsersControllerGetFinancialSummaryData | undefined;
        /**
         * @summary Get financial summary
         * @description Get comprehensive financial summary including balance and statistics
         */
        getInfiniteQueryKey(parameters: UsersControllerGetFinancialSummaryParameters | void): ServiceOperationInfiniteQueryKey<UsersControllerGetFinancialSummarySchema, UsersControllerGetFinancialSummaryParameters>;
        /**
         * Performs asynchronous data fetching with support for infinite scrolling scenarios.
         * Manages paginated data and provides utilities for fetching additional pages.
         *
         ...
         * ```
         */
        useSuspenseInfiniteQuery<TPageParam extends UsersControllerGetFinancialSummaryParameters, TData = UsersControllerGetFinancialSummaryData>(parameters: ServiceOperationInfiniteQueryKey<UsersControllerGetFinancialSummarySchema, UsersControllerGetFinancialSummaryParameters> | (UsersControllerGetFinancialSummaryParameters | void), options: Omit<UseSuspenseInfiniteQueryOptions<UsersControllerGetFinancialSummaryData, UsersControllerGetFinancialSummaryError, OperationInfiniteData<TData, UsersControllerGetFinancialSummaryParameters>, UsersControllerGetFinancialSummaryData, ServiceOperationInfiniteQueryKey<UsersControllerGetFinancialSummarySchema, UsersControllerGetFinancialSummaryParameters>, PartialParameters<TPageParam>>, "queryKey" | "getPreviousPageParam" | "getNextPageParam" | "initialPageParam"> & InfiniteQueryPageParamsOptions<UsersControllerGetFinancialSummaryData, PartialParameters<TPageParam>>): UseSuspenseInfiniteQueryResult<OperationInfiniteData<TData, UsersControllerGetFinancialSummaryParameters>, UsersControllerGetFinancialSummaryError | Error>;
        /**
         * @summary Get financial summary
         * @description Get comprehensive financial summary including balance and statistics
         */
    ...
    usersControllerGetTopTags: {
         ...
         * @description Get summary of top tags for both inflows and expenses
         */
        getQueryKey(parameters: UsersControllerGetTopTagsParameters | void): ServiceOperationQueryKey<UsersControllerGetTopTagsSchema, UsersControllerGetTopTagsParameters>;
        /**
         * Performs asynchronous data fetching, manages loading states and error handling.
         *
         * @summary Get top tags
         ...
         * ```
         */
        useQuery<TData = UsersControllerGetTopTagsData>(parameters: ServiceOperationQueryKey<UsersControllerGetTopTagsSchema, UsersControllerGetTopTagsParameters> | (UsersControllerGetTopTagsParameters | void), options: Omit<DefinedInitialDataOptions<UsersControllerGetTopTagsData, UsersControllerGetTopTagsError, TData, ServiceOperationQueryKey<UsersControllerGetTopTagsSchema, UsersControllerGetTopTagsParameters>>, "queryKey">): DefinedUseQueryResult<TData, UsersControllerGetTopTagsError | Error>;
        /**
         * @summary Get top tags
         * @description Get summary of top tags for both inflows and expenses
         */
         ...
         * @description Get summary of top tags for both inflows and expenses
         */
        fetchQuery(options: ServiceOperationFetchQueryOptions<UsersControllerGetTopTagsSchema, UsersControllerGetTopTagsData, UsersControllerGetTopTagsParameters, UsersControllerGetTopTagsError> | void): Promise<UsersControllerGetTopTagsData>;
        /**
         * @summary Get top tags
         * @description Get summary of top tags for both inflows and expenses
         */
        prefetchQuery(options: ServiceOperationFetchQueryOptions<UsersControllerGetTopTagsSchema, UsersControllerGetTopTagsData, UsersControllerGetTopTagsParameters, UsersControllerGetTopTagsError> | void): Promise<void>;
        /**
         * @summary Get top tags
         * @description Get summary of top tags for both inflows and expenses
         */
        ensureQueryData(options: ServiceOperationEnsureQueryDataOptions<UsersControllerGetTopTagsSchema, UsersControllerGetTopTagsData, UsersControllerGetTopTagsParameters, UsersControllerGetTopTagsError> | void): Promise<UsersControllerGetTopTagsData>;
        /**
         * @summary Get top tags
         * @description Get summary of top tags for both inflows and expenses
         */
        getInfiniteQueryData(parameters: ServiceOperationInfiniteQueryKey<UsersControllerGetTopTagsSchema, UsersControllerGetTopTagsParameters> | (UsersControllerGetTopTagsParameters | void)): OperationInfiniteData<UsersControllerGetTopTagsData, UsersControllerGetTopTagsParameters> | undefined;
        /**
         * @summary Get top tags
         * @description Get summary of top tags for both inflows and expenses
         */
         ...
         * @description Get summary of top tags for both inflows and expenses
         */
        getQueryData(parameters: ServiceOperationQueryKey<UsersControllerGetTopTagsSchema, UsersControllerGetTopTagsParameters> | (UsersControllerGetTopTagsParameters | void)): UsersControllerGetTopTagsData | undefined;
        /**
         * @summary Get top tags
         * @description Get summary of top tags for both inflows and expenses
         */
        getQueryState(parameters: ServiceOperationQueryKey<UsersControllerGetTopTagsSchema, UsersControllerGetTopTagsParameters> | (UsersControllerGetTopTagsParameters | void)): QueryState<UsersControllerGetTopTagsData, UsersControllerGetTopTagsError> | undefined;
        /**
         * @summary Get top tags
         * @description Get summary of top tags for both inflows and expenses
         */
        getInfiniteQueryState(parameters: UsersControllerGetTopTagsParameters | ServiceOperationInfiniteQueryKey<UsersControllerGetTopTagsSchema, UsersControllerGetTopTagsParameters> | void): QueryState<OperationInfiniteData<UsersControllerGetTopTagsData, UsersControllerGetTopTagsParameters>, UsersControllerGetTopTagsError> | undefined;
        /**
         * @summary Get top tags
         * @description Get summary of top tags for both inflows and expenses
         */
         ...
         * @description Get summary of top tags for both inflows and expenses
         */
        <TMeta extends Record<string, any>, TSignal extends AbortSignal = AbortSignal>(options: QueryFnOptionsByQueryKey<UsersControllerGetTopTagsSchema, UsersControllerGetTopTagsParameters, TMeta, TSignal> | (QueryFnOptionsByParameters<UsersControllerGetTopTagsParameters, TMeta, TSignal> | void), client?: (schema: UsersControllerGetTopTagsSchema, options: {
         ...
         * @description Get summary of top tags for both inflows and expenses
         */
        setQueryData(parameters: (UsersControllerGetTopTagsParameters | undefined) | ServiceOperationQueryKey<UsersControllerGetTopTagsSchema, UsersControllerGetTopTagsParameters>, updater: Updater<NoInfer<UsersControllerGetTopTagsData> | undefined, NoInfer<UsersControllerGetTopTagsData> | undefined>, options?: SetDataOptions): UsersControllerGetTopTagsData | undefined;
        /**
         * @summary Get top tags
         * @description Get summary of top tags for both inflows and expenses
         */
        getInfiniteQueryKey(parameters: UsersControllerGetTopTagsParameters | void): ServiceOperationInfiniteQueryKey<UsersControllerGetTopTagsSchema, UsersControllerGetTopTagsParameters>;
        /**
         * Performs asynchronous data fetching with support for infinite scrolling scenarios.
         * Manages paginated data and provides utilities for fetching additional pages.
         *
    ...
    usersControllerGetBalanceHistory: {
         ...
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        cancelQueries<TInfinite extends boolean = false>(filters?: QueryFiltersByParameters<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryData, TInfinite, UsersControllerGetBalanceHistoryParameters, UsersControllerGetBalanceHistoryError> | QueryFiltersByQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryData, TInfinite, UsersControllerGetBalanceHistoryParameters, UsersControllerGetBalanceHistoryError>, options?: CancelOptions): Promise<void>;
        /**
         * @summary Get balance history
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        getQueryKey(parameters: UsersControllerGetBalanceHistoryParameters | void): ServiceOperationQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters>;
        /**
         * Performs asynchronous data fetching, manages loading states and error handling.
         *
         * @summary Get balance history
         ...
         * ```
         */
        useQuery<TData = UsersControllerGetBalanceHistoryData>(parameters: ServiceOperationQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters> | (UsersControllerGetBalanceHistoryParameters | void), options?: Omit<UndefinedInitialDataOptions<UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryError, TData, ServiceOperationQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters>>, "queryKey">): UseQueryResult<TData, UsersControllerGetBalanceHistoryError | Error>;
        /**
         * Performs asynchronous data fetching, manages loading states and error handling.
         *
         * @summary Get balance history
         ...
         * ```
         */
        useQuery<TData = UsersControllerGetBalanceHistoryData>(parameters: ServiceOperationQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters> | (UsersControllerGetBalanceHistoryParameters | void), options: Omit<DefinedInitialDataOptions<UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryError, TData, ServiceOperationQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters>>, "queryKey">): DefinedUseQueryResult<TData, UsersControllerGetBalanceHistoryError | Error>;
        /**
         * @summary Get balance history
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        fetchInfiniteQuery<TPageParam extends UsersControllerGetBalanceHistoryParameters>(options: ServiceOperationFetchInfiniteQueryOptions<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryParameters, TPageParam, UsersControllerGetBalanceHistoryError>): Promise<OperationInfiniteData<UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryParameters>>;
        /**
         * @summary Get balance history
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        prefetchInfiniteQuery<TPageParam extends UsersControllerGetBalanceHistoryParameters>(options: ServiceOperationFetchInfiniteQueryOptions<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryParameters, TPageParam, UsersControllerGetBalanceHistoryError>): Promise<void>;
        /**
         * @summary Get balance history
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        ensureInfiniteQueryData<TPageParam extends UsersControllerGetBalanceHistoryParameters>(options: ServiceOperationEnsureInfiniteQueryDataOptions<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryParameters, TPageParam, UsersControllerGetBalanceHistoryError>): Promise<OperationInfiniteData<UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryParameters>>;
        /**
         * @summary Get balance history
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        fetchQuery(options: ServiceOperationFetchQueryOptions<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryParameters, UsersControllerGetBalanceHistoryError> | void): Promise<UsersControllerGetBalanceHistoryData>;
        /**
         * @summary Get balance history
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        prefetchQuery(options: ServiceOperationFetchQueryOptions<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryParameters, UsersControllerGetBalanceHistoryError> | void): Promise<void>;
        /**
         * @summary Get balance history
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        ensureQueryData(options: ServiceOperationEnsureQueryDataOptions<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryParameters, UsersControllerGetBalanceHistoryError> | void): Promise<UsersControllerGetBalanceHistoryData>;
        /**
         * @summary Get balance history
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        getInfiniteQueryData(parameters: ServiceOperationInfiniteQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters> | (UsersControllerGetBalanceHistoryParameters | void)): OperationInfiniteData<UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryParameters> | undefined;
        /**
         * @summary Get balance history
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        getQueriesData<TInfinite extends boolean = false>(filters?: QueryFiltersByParameters<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryData, TInfinite, UsersControllerGetBalanceHistoryParameters, UsersControllerGetBalanceHistoryError> | QueryFiltersByQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryData, TInfinite, UsersControllerGetBalanceHistoryParameters, UsersControllerGetBalanceHistoryError>): TInfinite extends true ? Array<[
            queryKey: ServiceOperationInfiniteQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters>,
            data: NoInfer<OperationInfiniteData<UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryParameters>> | undefined
        ]> : Array<[
            queryKey: ServiceOperationQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters>,
         ...
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        getQueryData(parameters: ServiceOperationQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters> | (UsersControllerGetBalanceHistoryParameters | void)): UsersControllerGetBalanceHistoryData | undefined;
        /**
         * @summary Get balance history
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        getQueryState(parameters: ServiceOperationQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters> | (UsersControllerGetBalanceHistoryParameters | void)): QueryState<UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryError> | undefined;
        /**
         * @summary Get balance history
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        getInfiniteQueryState(parameters: UsersControllerGetBalanceHistoryParameters | ServiceOperationInfiniteQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters> | void): QueryState<OperationInfiniteData<UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryParameters>, UsersControllerGetBalanceHistoryError> | undefined;
        /**
         * @summary Get balance history
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        invalidateQueries<TInfinite extends boolean = false>(filters?: InvalidateQueryFilters<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryData, TInfinite, UsersControllerGetBalanceHistoryParameters, UsersControllerGetBalanceHistoryError>, options?: InvalidateOptions): Promise<void>;
        /**
         * @summary Get balance history
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        isFetching<TInfinite extends boolean = false>(filters?: QueryFiltersByParameters<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryData, TInfinite, UsersControllerGetBalanceHistoryParameters, UsersControllerGetBalanceHistoryError> | QueryFiltersByQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryData, TInfinite, UsersControllerGetBalanceHistoryParameters, UsersControllerGetBalanceHistoryError>): number;
        /**
         * @summary Get balance history
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        <TMeta extends Record<string, any>, TSignal extends AbortSignal = AbortSignal>(options: QueryFnOptionsByQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters, TMeta, TSignal> | (QueryFnOptionsByParameters<UsersControllerGetBalanceHistoryParameters, TMeta, TSignal> | void), client?: (schema: UsersControllerGetBalanceHistorySchema, options: {
            parameters: UsersControllerGetBalanceHistoryParameters;
            signal?: TSignal;
            meta?: TMeta;
        }) => Promise<RequestFnResponse<UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryError>>): Promise<RequestFnResponse<UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryError>>;
        /**
         * @summary Get balance history
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        refetchQueries<TInfinite extends boolean = false>(filters?: QueryFiltersByParameters<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryData, TInfinite, UsersControllerGetBalanceHistoryParameters, UsersControllerGetBalanceHistoryError> | QueryFiltersByQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryData, TInfinite, UsersControllerGetBalanceHistoryParameters, UsersControllerGetBalanceHistoryError>, options?: RefetchOptions): Promise<void>;
        /**
         * @summary Get balance history
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        removeQueries<TInfinite extends boolean = false>(filters?: QueryFiltersByParameters<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryData, TInfinite, UsersControllerGetBalanceHistoryParameters, UsersControllerGetBalanceHistoryError> | QueryFiltersByQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryData, TInfinite, UsersControllerGetBalanceHistoryParameters, UsersControllerGetBalanceHistoryError>): void;
        /**
         * @summary Get balance history
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        resetQueries<TInfinite extends boolean = false>(filters?: QueryFiltersByParameters<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryData, TInfinite, UsersControllerGetBalanceHistoryParameters, UsersControllerGetBalanceHistoryError> | QueryFiltersByQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryData, TInfinite, UsersControllerGetBalanceHistoryParameters, UsersControllerGetBalanceHistoryError>, options?: ResetOptions): Promise<void>;
        /**
         * @summary Get balance history
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        setInfiniteQueryData(parameters: UsersControllerGetBalanceHistoryParameters | ServiceOperationInfiniteQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters>, updater: Updater<NoInfer<OperationInfiniteData<UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryParameters>> | undefined, NoInfer<OperationInfiniteData<UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryParameters>> | undefined>, options?: SetDataOptions): OperationInfiniteData<UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryParameters> | undefined;
        /**
         * @summary Get balance history
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        setQueriesData<TInfinite extends boolean = false>(filters: QueryFiltersByParameters<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryData, TInfinite, UsersControllerGetBalanceHistoryParameters, UsersControllerGetBalanceHistoryError> | QueryFiltersByQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryData, TInfinite, UsersControllerGetBalanceHistoryParameters, UsersControllerGetBalanceHistoryError>, updater: Updater<NoInfer<UsersControllerGetBalanceHistoryData> | undefined, NoInfer<UsersControllerGetBalanceHistoryData> | undefined>, options?: SetDataOptions): Array<UsersControllerGetBalanceHistoryData | undefined>;
        /**
         * @summary Get balance history
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        setQueryData(parameters: (UsersControllerGetBalanceHistoryParameters | undefined) | ServiceOperationQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters>, updater: Updater<NoInfer<UsersControllerGetBalanceHistoryData> | undefined, NoInfer<UsersControllerGetBalanceHistoryData> | undefined>, options?: SetDataOptions): UsersControllerGetBalanceHistoryData | undefined;
        /**
         * @summary Get balance history
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        getInfiniteQueryKey(parameters: UsersControllerGetBalanceHistoryParameters | void): ServiceOperationInfiniteQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters>;
        /**
         * Performs asynchronous data fetching with support for infinite scrolling scenarios.
         * Manages paginated data and provides utilities for fetching additional pages.
         *
         ...
         * ```
         */
        useInfiniteQuery<TPageParam extends UsersControllerGetBalanceHistoryParameters, TData = UsersControllerGetBalanceHistoryData>(parameters: ServiceOperationInfiniteQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters> | (UsersControllerGetBalanceHistoryParameters | void), options: Omit<UndefinedInitialDataInfiniteOptions<UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryError, OperationInfiniteData<TData, UsersControllerGetBalanceHistoryParameters>, ServiceOperationInfiniteQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters>, PartialParameters<TPageParam>>, "queryKey" | "getPreviousPageParam" | "getNextPageParam" | "initialPageParam"> & InfiniteQueryPageParamsOptions<UsersControllerGetBalanceHistoryData, PartialParameters<TPageParam>>): UseInfiniteQueryResult<OperationInfiniteData<TData, UsersControllerGetBalanceHistoryParameters>, UsersControllerGetBalanceHistoryError | Error>;
        /**
         * Performs asynchronous data fetching with support for infinite scrolling scenarios.
         * Manages paginated data and provides utilities for fetching additional pages.
         *
         ...
         * ```
         */
        useInfiniteQuery<TPageParam extends UsersControllerGetBalanceHistoryParameters, TData = UsersControllerGetBalanceHistoryData>(parameters: ServiceOperationInfiniteQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters> | (UsersControllerGetBalanceHistoryParameters | void), options: Omit<DefinedInitialDataInfiniteOptions<UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryError, OperationInfiniteData<TData, UsersControllerGetBalanceHistoryParameters>, ServiceOperationInfiniteQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters>, PartialParameters<TPageParam>>, "queryKey" | "getPreviousPageParam" | "getNextPageParam" | "initialPageParam"> & InfiniteQueryPageParamsOptions<UsersControllerGetBalanceHistoryData, PartialParameters<TPageParam>>): DefinedUseInfiniteQueryResult<OperationInfiniteData<TData, UsersControllerGetBalanceHistoryParameters>, UsersControllerGetBalanceHistoryError | Error>;
        /**
         * Monitors the number of queries currently fetching, matching the provided filters.
         * Useful for creating loading indicators or performing actions based on active requests.
         *
         ...
         * ```
         */
        useIsFetching<TInfinite extends boolean = false>(filters?: QueryFiltersByParameters<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryData, TInfinite, UsersControllerGetBalanceHistoryParameters, UsersControllerGetBalanceHistoryError> | QueryFiltersByQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryData, TInfinite, UsersControllerGetBalanceHistoryParameters, UsersControllerGetBalanceHistoryError>): number;
        /**
         * Allows you to execute multiple asynchronous data fetching operations concurrently. This is especially useful for managing complex data dependencies in parallel.
         *
         * @summary Get balance history
         ...
         * ```
         */
        useQueries<T extends Array<UseQueryOptionsForUseQueries<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters, UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryError>>, TCombinedResult = Array<UseQueryResult<UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryError>>>(options: {
            queries: T;
            combine?: (results: Array<UseQueryResult<UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryError>>) => TCombinedResult;
        }): TCombinedResult;
        /**
         * @summary Get balance history
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         ...
         * ```
         */
        useSuspenseInfiniteQuery<TPageParam extends UsersControllerGetBalanceHistoryParameters, TData = UsersControllerGetBalanceHistoryData>(parameters: ServiceOperationInfiniteQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters> | (UsersControllerGetBalanceHistoryParameters | void), options: Omit<UseSuspenseInfiniteQueryOptions<UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryError, OperationInfiniteData<TData, UsersControllerGetBalanceHistoryParameters>, UsersControllerGetBalanceHistoryData, ServiceOperationInfiniteQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters>, PartialParameters<TPageParam>>, "queryKey" | "getPreviousPageParam" | "getNextPageParam" | "initialPageParam"> & InfiniteQueryPageParamsOptions<UsersControllerGetBalanceHistoryData, PartialParameters<TPageParam>>): UseSuspenseInfiniteQueryResult<OperationInfiniteData<TData, UsersControllerGetBalanceHistoryParameters>, UsersControllerGetBalanceHistoryError | Error>;
        /**
         * @summary Get balance history
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        useSuspenseQueries<T extends Array<UseQueryOptionsForUseSuspenseQuery<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters, UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryError>>, TCombinedResult = Array<UseSuspenseQueryResult<UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryError>>>(options: {
            queries: T;
            combine?: (results: Array<WithOptional<UseSuspenseQueryResult<UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryError>, "data">>) => TCombinedResult;
        }): TCombinedResult;
        /**
         * @summary Get balance history
         * @description Get complete history of monthly balances with cumulative totals for plotting trends
         */
        useSuspenseQuery<TData = UsersControllerGetBalanceHistoryData>(parameters: ServiceOperationQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters> | (UsersControllerGetBalanceHistoryParameters | void), options?: Omit<UseSuspenseQueryOptions<UsersControllerGetBalanceHistoryData, UsersControllerGetBalanceHistoryError, TData, ServiceOperationQueryKey<UsersControllerGetBalanceHistorySchema, UsersControllerGetBalanceHistoryParameters>>, "queryKey">): UseSuspenseQueryResult<TData, UsersControllerGetBalanceHistoryError | Error>;
...
type UsersControllerGetMonthlyBalanceParameters = paths["/users/monthly-balance/{year}"]["get"]["parameters"];
type UsersControllerGetMonthlyBalanceData = paths["/users/monthly-balance/{year}"]["get"]["responses"]["200"]["content"]["application/json"];
...
type UsersControllerGetFinancialSummaryData = paths["/users/financial-summary"]["get"]["responses"]["200"]["content"]["application/json"];
...
type UsersControllerGetTopTagsData = paths["/users/top-tags"]["get"]["responses"]["200"]["content"]["application/json"];
...
type UsersControllerGetBalanceHistoryData = paths["/users/balance-history"]["get"]["responses"]["200"]["content"]["application/json"];
