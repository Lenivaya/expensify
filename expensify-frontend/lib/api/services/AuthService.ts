...
export interface AuthService {
    ...
    authControllerSignIn: {
         ...
         * ```
         */
        useIsMutating<TContext = unknown>(filters?: MutationFiltersByParameters<AuthControllerSignInBody, AuthControllerSignInData, AuthControllerSignInParameters, AuthControllerSignInError, TContext> | MutationFiltersByMutationKey<AuthControllerSignInSchema, AuthControllerSignInBody, AuthControllerSignInData, AuthControllerSignInParameters, AuthControllerSignInError, TContext>): number;
        /**
         * @summary Sign in a user
         * @description This endpoint allows a user to sign in by providing valid credentials. On successful authentication, a token is generated and returned.
         */
         ...
         * ```
         */
        useMutationState<TContext = unknown, TResult = MutationState<AuthControllerSignInData, AuthControllerSignInError, MutationVariables<AuthControllerSignInBody, AuthControllerSignInParameters>, TContext>>(options?: {
            filters?: MutationFiltersByParameters<AuthControllerSignInBody, AuthControllerSignInData, AuthControllerSignInParameters, AuthControllerSignInError, TContext> | MutationFiltersByMutationKey<AuthControllerSignInSchema, AuthControllerSignInBody, AuthControllerSignInData, AuthControllerSignInParameters, AuthControllerSignInError, TContext>;
            select?: (mutation: Mutation<AuthControllerSignInData, AuthControllerSignInError, MutationVariables<AuthControllerSignInBody, AuthControllerSignInParameters>, TContext>) => TResult;
        }): Array<TResult>;
    ...
    authControllerSignUp: {
         ...
         * ```
         */
        useIsMutating<TContext = unknown>(filters?: MutationFiltersByParameters<AuthControllerSignUpBody, AuthControllerSignUpData, AuthControllerSignUpParameters, AuthControllerSignUpError, TContext> | MutationFiltersByMutationKey<AuthControllerSignUpSchema, AuthControllerSignUpBody, AuthControllerSignUpData, AuthControllerSignUpParameters, AuthControllerSignUpError, TContext>): number;
        /**
         * @summary Sign up a new user
         * @description This endpoint allows a new user to sign up by providing necessary registration details. On successful registration, user details are returned.
         */
         ...
         * ```
         */
        useMutationState<TContext = unknown, TResult = MutationState<AuthControllerSignUpData, AuthControllerSignUpError, MutationVariables<AuthControllerSignUpBody, AuthControllerSignUpParameters>, TContext>>(options?: {
            filters?: MutationFiltersByParameters<AuthControllerSignUpBody, AuthControllerSignUpData, AuthControllerSignUpParameters, AuthControllerSignUpError, TContext> | MutationFiltersByMutationKey<AuthControllerSignUpSchema, AuthControllerSignUpBody, AuthControllerSignUpData, AuthControllerSignUpParameters, AuthControllerSignUpError, TContext>;
            select?: (mutation: Mutation<AuthControllerSignUpData, AuthControllerSignUpError, MutationVariables<AuthControllerSignUpBody, AuthControllerSignUpParameters>, TContext>) => TResult;
        }): Array<TResult>;
        schema: AuthControllerSignUpSchema;
        types: {
